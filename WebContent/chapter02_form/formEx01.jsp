...
<body>
		...
		<!-- method속성에 데이터를 전송할 방식을 작성한다(default눈 get방식)-->
		<form action="formEx01Pro.jsp" method="post" name="f">
		<fieldset>
			<!-- form태그 안에 있는 name 속성에 이름으로 데이터가 서버로 전송된다. -->
			...
			<!-- 전송방법1)submit타입을 이용해서 서버로 전송한다.-->
			<input type="submit" value="입력완료">
			
			
			<!-- 전송방법2)자바스크립트를 이용하여 서버로 전송한다.-->
